(function () {
    ...
    angular.module('app.ui.form')
        .controller('WizardCtrl', ['$scope', '$q', '$timeout', 'WizardHandler', '$window', '$mdDialog','curriculoService', WizardCtrl])
         .service('curriculoService', function($http, $window) {
    ...
    function WizardCtrl ($scope, $q, $timeout, WizardHandler, $window, $mdDialog, curriculoService) {
        ...
        $scope.criarCurriculo = function(curriculo) {
                   ...
                   curriculoService.criarCurriculo(curriculo);
