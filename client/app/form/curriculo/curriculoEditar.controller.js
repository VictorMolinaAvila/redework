(function () {
    ...
    angular.module('app.ui.form')
        .controller('curriculoEditarController', ['$scope', '$q', '$timeout', 'WizardHandler', '$window', '$mdDialog', '$stateParams', 'curriculoEditarService', curriculoEditarController])
    ...
    this.editarCurriculo = function(curriculo){
    ...
    function curriculoEditarController ($scope, $q, $timeout, WizardHandler, $window, $mdDialog, $stateParams, curriculoEditarService) {
        ...
        curriculoEditarService.obterCurriculo($stateParams.id).then(function(d){

          $scope.curriculo = d.data;
          $scope.listaFormacao = d.data.formacoes;
          $scope.listaIdioma = d.data.idiomas;
          $scope.listaExperienciaProfissional = d.data.experienciasProfissionais;
          $scope.listaHabilidade = d.data.habilidades;
        ...
        $scope.editarCurriculo = function(curriculo) {
                   ...
                   curriculoEditarService.editarCurriculo(curriculo);
